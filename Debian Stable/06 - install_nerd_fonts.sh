...
if [[ "$DRY_RUN" -eq 0 ]]; then
    require_cmd "curl" "Installez-la par ex: sudo apt-get update && sudo apt-get install -y curl"
    require_cmd "unzip" "Installez-la par ex: sudo apt-get update && sudo apt-get install -y unzip"
    require_cmd "fc-cache" "Installez-la par ex: sudo apt-get update && sudo apt-get install -y fontconfig"
fi
