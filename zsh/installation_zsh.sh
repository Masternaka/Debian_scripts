...
if command -v eza &>/dev/null; then
    alias ls='eza --group-directories-first --icons=always --color=auto'
    alias ll='eza -lah --group-directories-first --icons=always'
    alias la='eza -a --group-directories-first --icons=always'
    alias l='eza --group-directories-first --icons=always'
    alias lt='eza -lah --sort=modified --group-directories-first --icons=always' # Triés par date
    alias lS='eza -lah --sort=size --group-directories-first --icons=always'     # Triés par taille
else
